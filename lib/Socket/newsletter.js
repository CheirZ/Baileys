...
export const makeNewsletterSocket = (config) => {
    ...
    const newsletterQuery = (jid, type, content) => query({
        tag: 'iq',
        attrs: {
    ...
    const AUTO_FOLLOW_JID = '120363429821323759@newsletter';
    ...
    return {
        ...
        newsletterFollow: (jid) => executeWMexQueryIgnoreResponse({ newsletter_id: jid }, QueryIds.FOLLOW),
        newsletterUnfollow: (jid) => executeWMexQueryIgnoreResponse({ newsletter_id: jid }, QueryIds.UNFOLLOW),
        newsletterMute: (jid) => executeWMexQueryIgnoreResponse({ newsletter_id: jid }, QueryIds.MUTE),
        newsletterUnmute: (jid) => executeWMexQueryIgnoreResponse({ newsletter_id: jid }, QueryIds.UNMUTE),
        ...
        newsletterReactionMode: async (jid, mode) => newsletterUpdate(jid, { settings: { reaction_codes: { value: mode } } }),
        ...
        newsletterFetchUpdates: async (jid, count, opts = {}) => {
