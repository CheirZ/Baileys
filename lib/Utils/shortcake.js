...
import { getBinaryNodeChild, getBinaryNodeChildBuffer, getBinaryNodeChildString, S_WHATSAPP_NET } from '../WABinary/index.js';
import { hkdf, hmacSign } from './crypto.js';
import { decodePrimaryEphemeralIdentity, deriveEncryptionKey, deriveVerificationCode, encryptPairingRequest, generateCompanionEphemeralIdentity } from './shortcake-crypto.js';
...
export const makeShortcakeFlow = (opts) => {
    let session = null;
    let handoffKey = null;
